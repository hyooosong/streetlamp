...
class CustomTextStyle {
  ...
  static var semibold_14_black = TextStyle(fontFamily: "Pretendard", fontWeight: FontWeight.w600, fontSize: 14.w, color: CustomColors.BLACK);
  static var medium_14_black = TextStyle(fontFamily: "Pretendard", fontWeight: FontWeight.w500, fontSize: 14.w, color: CustomColors.BLACK);
  ...
  static var bold_12_purple = TextStyle(fontFamily: "Pretendard", fontWeight: FontWeight.bold, fontSize: 12.w, color: CustomColors.PURPLE);
  static var bold_14_purple = TextStyle(fontFamily: "Pretendard", fontWeight: FontWeight.bold, fontSize: 14.w, color: CustomColors.PURPLE);
